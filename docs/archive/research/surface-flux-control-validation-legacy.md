# Surface Flux Control Validation Legacy Record

> **Status: Historical, superseded mixed record.** This file preserves the
> substantive validation and implementation-decision record from issues #286
> and #305 and PRs #303 and #308. Its point-in-time recommendations do not state
> current implementation status or product direction and do not define a
> supported Recipe. See the [current surface-flux evidence
> status](../../research/surface-flux-control-validation.md).
